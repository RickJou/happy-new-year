...
func main() {
	os.Args = append(os.Args, "-config", "/Users/alan/Desktop/source_read/my_github_code/dendrite-10.7/dendrite/cmd/dendrite-monolith-server/dendrite.yaml")
	os.Args = append(os.Args, "-http-bind-address", ":8008")
